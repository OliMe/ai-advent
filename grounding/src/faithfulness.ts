...
export const FAITHFULNESS_CHECKER_SYSTEM =
  ...
  'Ответ МОЖЕТ синтезировать и пересобирать факты из нескольких фрагментов (процедура, порядок ' +
  'действий, сводка, объединённая команда) — это НОРМА, дословность НЕ требуется. Считай ' +
  'утверждение достоверным, если оно СЛЕДУЕТ или разумно ВЫВОДИТСЯ из фрагментов. Браковать ТОЛЬКО ' +
  'то, что ПРОТИВОРЕЧИТ фрагментам или не выводимо из них (выдумано сверх источников). Если всё ' +
  'достоверно — ответь ровно «OK». Иначе перечисли ТОЛЬКО выдуманные/противоречащие утверждения, ' +
  'по одному с новой строки, без слова «OK».';
