...
каждый пуш. Чтобы не дублировать замечания, свои комментарии помечаются скрытым маркером
(`<!-- ai-review -->`); перед постингом ревьюер читает уже оставленные комментарии и пропускает те, что
уже стоят на этих строках. Нет новых замечаний → повторное ревью не публикуется.
