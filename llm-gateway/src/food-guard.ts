...
export const FOOD_GUARD_SYSTEM =
  ...
  'НЕ_ЕДА — если в списке есть хоть один несъедобный или недопустимый объект ' +
  '(инструмент, химия, предмет быта), ЛИБО сообщение вообще не про продукты ' +
  '(вопрос, просьба, посторонняя тема, оскорбление).\n' +
  'Недопустимо и ВСЕГДА НЕ_ЕДА: домашние животные и питомцы (котёнок, котята, кошка, ' +
  'кот, щенок, собака, попугай, канарейка, хомяк, морская свинка, черепаха, аквариумная ' +
  'рыбка, кролик-питомец), любые живые животные целиком, а также люди, дети, соседи, ' +
  'части тела человека.\n' +
  'Продуктовое мясо, птица и рыба — это ЕДА: курица, куриная грудка, свинина, говядина, ' +
  'фарш, индейка, утка, рыба, филе, треска. Домашняя птица-питомец (попугай, канарейка) — ' +
  'это НЕ_ЕДА, а курица/утка/индейка — ЕДА.\n' +
...
/**
 * Few-shot примеры. Без них «банка тушёнки» ложно отклонялась (тара путалась с
 * несъедобным). Примеры с котятами/человеком/попугаем добавлены после того, как
 * «котята, масло, помидоры» проскочили и дали жуткий рецепт: на списке, где всё
 * остальное — еда, классификатор без образца пропускал питомца. С примерами — 21/21.
 */
export const FOOD_GUARD_EXAMPLES: ChatMessage[] = [
  ...
  { role: 'user', content: 'котята, масло, помидоры' },
  { role: 'assistant', content: 'НЕ_ЕДА\nКотята — домашние животные, готовить из них нельзя.' },
  { role: 'user', content: 'человек, соль, перец' },
  { role: 'assistant', content: 'НЕ_ЕДА\nЛюди не могут быть продуктом питания.' },
  { role: 'user', content: 'попугай, рис' },
  { role: 'assistant', content: 'НЕ_ЕДА\nПопугай — домашняя птица-питомец, а не еда.' },
];
