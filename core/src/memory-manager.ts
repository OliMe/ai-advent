...
export class MemoryManager {
  ...
  private async extract(newMessages: ChatMessage[]): Promise<CompletionResult> {
    ...
    const instruction =
      ...
      'идёт в "user"). Формулируй СТРОГО по текущим словам пользователя: не инвертируй и ' +
      'не бери из истории/профиля/ранее удалённого. Дай краткую формулировку; иначе "". ' +
