...
function plannerRoleSystem(role: AgentRole): string {
  return (
    ...
    'и не выходи за рамки своей роли — общий план соберёт ведущий планировщик. Для плана НЕ ' +
    ...
    'этап ВЫПОЛНЕНИЯ, не ты. Ответь кратко по делу (можно списком); JSON не требуется.'
  );
}
