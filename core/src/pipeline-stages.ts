...
const EXECUTOR_FILE_SYSTEM =
  ...
  'изменений: не делай правок вообще. Применяй изменения инструментами (например, write_file), а НЕ ' +
  'описывай их словами и не возвращай код в ответе. Пути указывай ОТНОСИТЕЛЬНО корня проекта. Раскладка файлов проекта дана ' +
